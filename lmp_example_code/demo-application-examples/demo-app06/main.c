//******************************************************************************
//  Demo Application06 for MSP430/LMP90100 Interface Code Library v1.0
//  Controlled Stream Read ADC Data & status (2 channels) with interrupt and CRC Check
//
//                MSP430F5528
//             -----------------
//         /|\|              XIN|-
...
void main(void)
{
  ...
  while (1)
  {
    if (LMP90100_ADCDataReady)
    {
      ...
      TI_LMP90100_SPIControlledStreamReadADC(addr, read_buf, count, &prev_URA);    // read status, adc output & CRC into read_buf
