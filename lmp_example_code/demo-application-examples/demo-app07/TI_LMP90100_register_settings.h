...
#define TI_LMP90100_SPI_HANDSHAKECN_REG_VALUE          (0x07)             /* SPI SDO High Z Delayed, DRDYB driving */ 
...
#define TI_LMP90100_GPIO_DIRCN_REG_VALUE               (0x00)             /* D0-D6 inputs */
#define TI_LMP90100_GPIO_DAT_REG_VALUE                 (0x00)             /* D0-D6 clear */

#define TI_LMP90100_BGCALCN_REG_VALUE                  (0x00)             /* Background Calibration OFF */

#define TI_LMP90100_SPI_DRDYBCN_REG_VALUE              (0x03)             /* Disable DRDYB on D6, bits 0 & 1 must be 1, others default */
